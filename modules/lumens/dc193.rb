...
class Lumens::DC193
  ...
  tokenize indicator: "\xA0", msg_length: 6
  ...
  def zoom(direction)
    ...
    when "stop"
      send [0xA0, 0x10, 0x00, 0x00, 0x00, 0xAF]
